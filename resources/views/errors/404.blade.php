            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <img class="mb-30" src="assets/imgs/theme/404.png" alt="">
                        <h2 class="headline-1 font-heading">Page Not Found</h2>
                        <p class="font-lg text-grey-700">
                            The link you clicked may be broken or the page may have been removed.<br> visit the <a href="index.html"> <strong> Homepage</strong></a> or <a href="page-contact.html"><strong>Contact us</strong></a> about the problem
                        </p>
                        <form class="mt-50 w-50 m-auto" action="#" id="commentForm">
                            <div class="form-group">
                                <input class="form-control bg-white" name="username" id="username" type="text" placeholder="Search...">
                            </div>
                        </form>
                    </div>
                </div>
