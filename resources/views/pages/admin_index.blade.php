	...
	<div class="geex-header__wrapper">
		<div class="geex-header__logo-wrapper">
			<a href="index.html" class="geex-header__logo">
				<img class="logo-lite" src="/assets-admin/img/logo-dark.svg" alt="Header logo" />
				<img class="logo-dark" src="/assets-admin/img/logo-lite.svg" alt="Header logo" />
			</a>
		</div>
...
<div class="geex-content__header__action">
    ...
    <div class="geex-content__header__action__wrap">
        <ul class="geex-content__header__quickaction">
                            ...
                            <li class="geex-content__header__popup__item">
                                <a class="geex-content__header__popup__link" href="#">
                                    <div class="geex-content__header__popup__item__img">
                                        <img src="/assets-admin/img/avatar/user.svg" alt="Popup Img" class="" />
                                    </div>
            ...
            <li class="geex-content__header__quickaction__item">
                <a href="#" class="geex-content__header__quickaction__link">
                    <img class="user-img" src="/assets-admin/img/avatar/user.svg" alt="user" />
                </a>
                <div class="geex-content__header__popup geex-content__header__popup--author">
                    <div class="geex-content__header__popup__header">
                        <div class="geex-content__header__popup__header__img">
                            <img src="/assets-admin/img/avatar/user.svg" alt="user" />
                        </div>
                    ...
                    <div class="geex-content__header__popup__content">
                        <ul class="geex-content__header__popup__items">
                            <li class="geex-content__header__popup__item">
                                <a class="geex-content__header__popup__link" href="{{ route('profile') }}">
                    ...
                    <div class="geex-content__header__popup__footer">
                        <a href="{{ route('admin-logout') }}" class="geex-content__header__popup__footer__link">
					...
					<div class="geex-content__feature mb-40">
						<div class="geex-content__feature__card">
							...
							<div class="geex-content__feature__card__img">
								<img src="/assets-admin/img/feature/feature-2.svg" alt="feature" />
							</div>
						</div>
						<div class="geex-content__feature__card">
							<div class="geex-content__feature__card__text">
							...
							<div class="geex-content__feature__card__img">
								<img src="/assets-admin/img/feature/feature-3.svg" alt="feature" />
							</div>
						</div>
						<div class="geex-content__feature__card">
							<div class="geex-content__feature__card__text">
							...
							<div class="geex-content__feature__card__img">
								<img src="/assets-admin/img/feature/feature-1.svg" alt="feature" />
							</div>
						</div>
					</div>
								...
								<div class="swiper-wrapper">
										...
										<div class="geex-content__review__single">
											<div class="geex-content__review__single__header">
												<div class="geex-content__review__single__header__img">
													<img src="/assets-admin/img/testimonial/1.svg" alt="User" />
												</div>
									...
									<div class="swiper-slide">
										<div class="geex-content__review__single">
											<div class="geex-content__review__single__header">
												<div class="geex-content__review__single__header__img">
													<img src="/assets-admin/img/testimonial/2.svg" alt="User" />
												</div>
												<div class="geex-content__review__single__header__text">
									...
									<div class="swiper-slide">
										<div class="geex-content__review__single">
											<div class="geex-content__review__single__header">
												<div class="geex-content__review__single__header__img">
													<img src="/assets-admin/img/testimonial/3.svg" alt="User" />
												</div>
												<div class="geex-content__review__single__header__text">
									...
									<div class="swiper-slide">
										<div class="geex-content__review__single">
											<div class="geex-content__review__single__header">
												<div class="geex-content__review__single__header__img">
													<img src="/assets-admin/img/testimonial/4.svg" alt="User" />
												</div>
												<div class="geex-content__review__single__header__text">
													<h4 class="geex-content__review__single__header__title">Kevin Hunt</h4>
													<p class="geex-content__review__single__header__subtitle">6 days ago</p>
				...
				<div class="geex-content__widget">
					...
					<div class="geex-content__widget__single">
						...
						<div class="geex-content__widget__single__content">
							...
							<div class="geex-content__widget__single__cta mb-30">
								<div class="geex-content__widget__single__cta__img">
									<img src="/assets-admin/img/icon/facebook.svg" alt="google" />
								</div>
								<div class="geex-content__widget__single__cta__text">
							...
							<div class="geex-content__widget__single__cta">
								<div class="geex-content__widget__single__cta__img">
									<img src="/assets-admin/img/icon/youtube.svg" alt="google" />
								</div>
								<div class="geex-content__widget__single__cta__text">
