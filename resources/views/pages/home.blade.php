...
<body class="home-page-1">
    ...
    <!-- Vendor JS-->
    <script src="assets-admin/js/vendor/modernizr-3.5.0.min.js"></script>
    <script src="assets-admin/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="assets-admin/js/vendor/bootstrap.min.js"></script>
    <script src="assets-admin/js/vendor/jquery.slicknav.js"></script>
    <script src="assets-admin/js/vendor/slick.min.js"></script>
    <script src="assets-admin/js/vendor/wow.min.js"></script>
    <script src="assets-admin/js/vendor/jquery.scrollUp.min.js"></script>
    <script src="assets-admin/js/vendor/jquery.theia.sticky.js"></script>
    <!-- Template  JS -->
